...
//  Bus Ticker
//
//  Created by Brennan Stehling on 9/21/14.
...
+ (void)drawForecastWithScale: (CGFloat)scale;
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();
    ...
    //// Group
    {
        ...
        [cloudsPath moveToPoint: CGPointMake(512, 325.5)];
        [cloudsPath addCurveToPoint: CGPointMake(448, 389.5) controlPoint1: CGPointMake(512, 360.84) controlPoint2: CGPointMake(483.34, 389.5)];
        [cloudsPath addLineToPoint: CGPointMake(448, 390)];
        [cloudsPath addLineToPoint: CGPointMake(176, 390)];
        [cloudsPath addCurveToPoint: CGPointMake(96, 310) controlPoint1: CGPointMake(131.81, 390) controlPoint2: CGPointMake(96, 354.19)];
        [cloudsPath addCurveToPoint: CGPointMake(160.16, 231.59) controlPoint1: CGPointMake(96, 271.25) controlPoint2: CGPointMake(123.56, 238.94)];
        [cloudsPath addCurveToPoint: CGPointMake(160, 230) controlPoint1: CGPointMake(160.16, 231.06) controlPoint2: CGPointMake(160, 230.56)];
        [cloudsPath addCurveToPoint: CGPointMake(256, 134) controlPoint1: CGPointMake(160, 176.97) controlPoint2: CGPointMake(202.97, 134)];
        [cloudsPath addCurveToPoint: CGPointMake(341.34, 186.88) controlPoint1: CGPointMake(293.44, 134) controlPoint2: CGPointMake(325.5, 155.62)];
        [cloudsPath addCurveToPoint: CGPointMake(368, 182) controlPoint1: CGPointMake(349.72, 183.94) controlPoint2: CGPointMake(358.59, 182)];
        [cloudsPath addCurveToPoint: CGPointMake(447.91, 261) controlPoint1: CGPointMake(411.84, 182) controlPoint2: CGPointMake(447.34, 217.25)];
        [cloudsPath addLineToPoint: CGPointMake(448, 261)];
        [cloudsPath addLineToPoint: CGPointMake(448, 261.5)];
        [cloudsPath addCurveToPoint: CGPointMake(512, 325.5) controlPoint1: CGPointMake(483.34, 261.5) controlPoint2: CGPointMake(512, 290.16)];
        [cloudsPath closePath];
        [cloudsPath moveToPoint: CGPointMake(129.91, 207.94)];
        [cloudsPath addCurveToPoint: CGPointMake(204.47, 113.31) controlPoint1: CGPointMake(137.31, 165.38) controlPoint2: CGPointMake(166.06, 130.34)];
        [cloudsPath addCurveToPoint: CGPointMake(160, 102) controlPoint1: CGPointMake(191.19, 106.22) controlPoint2: CGPointMake(176.16, 102)];
        [cloudsPath addCurveToPoint: CGPointMake(64, 198) controlPoint1: CGPointMake(106.97, 102) controlPoint2: CGPointMake(64, 144.97)];
        [cloudsPath addCurveToPoint: CGPointMake(64.16, 199.59) controlPoint1: CGPointMake(64, 198.56) controlPoint2: CGPointMake(64.16, 199.06)];
        [cloudsPath addCurveToPoint: CGPointMake(0, 278) controlPoint1: CGPointMake(27.56, 206.94) controlPoint2: CGPointMake(0, 239.25)];
        [cloudsPath addCurveToPoint: CGPointMake(74.94, 357.5) controlPoint1: CGPointMake(0, 320.47) controlPoint2: CGPointMake(33.19, 354.84)];
        [cloudsPath addCurveToPoint: CGPointMake(64, 310) controlPoint1: CGPointMake(68.12, 343.03) controlPoint2: CGPointMake(64, 327.03)];
        [cloudsPath addCurveToPoint: CGPointMake(129.91, 207.94) controlPoint1: CGPointMake(64, 265.44) controlPoint2: CGPointMake(90.59, 225.75)];
        [cloudsPath closePath];
        cloudsPath.miterLimit = 4;
